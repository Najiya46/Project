...
import joblib
classi=joblib.load(r"C:\Users\HP\Titanic.pkl")
label1=joblib.load(r"C:\Users\HP\lb.pkl")                
label2=joblib.load(r"C:\Users\HP\lb1.pkl")
stand=joblib.load(r"C:\Users\HP\st.pkl")
...
if st.button("Predict"):
    result=classi.predict(stand.transform([[pclass,sex,age,sibp,parch,Fare,Embarked]]))[0]
    if result==0 :   
